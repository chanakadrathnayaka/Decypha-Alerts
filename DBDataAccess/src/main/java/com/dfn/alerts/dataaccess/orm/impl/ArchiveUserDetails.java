...
@Entity
@Table(name = "USR_ACCOUNT_DETAILS_ARCHIVE")
public class ArchiveUserDetails implements Serializable {
    ...
    @Id
    @Column(name = "ID")
    @SequenceGenerator(name = "ARCHIVE_USER", sequenceName = "HIBERNATE_ARCHIVE_USER")
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "ARCHIVE_USER")
    public Long getId() {
        return id;
    }
